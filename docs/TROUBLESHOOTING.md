# Troubleshooting — IT-Stack IREDMAIL
...
1. Check logs: docker compose logs iredmail
2. Verify environment variables are set correctly
3. Check database connectivity: pg_isready -h lab-db1 -p 5432
4. Verify port is not already in use: ss -tlnp | grep 25
...
```bash
# Test connectivity
psql -h lab-db1 -U iredmail_user -d iredmail_db -c '\conninfo'
...
1. Check resource usage: docker stats it-stack-iredmail
...
| Log | Path |
|-----|------|
| Application | docker compose logs iredmail |
