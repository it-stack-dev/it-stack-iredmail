# Lab 09-05 — Advanced Integration

**Module:** 09 — iRedMail email server  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-09-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect iredmail to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 09-01 through 09-04 pass
